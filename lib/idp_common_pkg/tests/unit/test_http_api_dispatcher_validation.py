...
def test_required_arg_count_is_stable(spec):
    ...
    visible in the diff (97 fields require a non-null arg as of this spec — the
    ...
    draft-labeling ops generateDraftLabels/getDraftLabelJob added 95–96, and
    estimateReviewEffort added the 97th)."""
    required = [
