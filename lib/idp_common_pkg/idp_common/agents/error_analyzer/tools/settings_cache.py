...
Usage::
    ...
    from idp_common.agents.error_analyzer.tools.settings_cache import SettingsCache
...
Or use the module-level singleton::
    ...
    from idp_common.agents.error_analyzer.tools.settings_cache import get_setting, get_cloudwatch_log_groups
