...
class DataExtractor:
    ...
    def extract_values(
        ...
        for mapping in rule_json.path_mappings:
            ...
            try:
                converted_value = self._convert_type(value, param.type, rule_json.rule_id, param_name, data_path)
            except ExtractionError:
                # Re-raise extraction errors
                raise
            except Exception as e:
    ...
    def _extract_path(self, data: dict, path: str, rule_id: Optional[str] = None) -> Any:
        """
            ...
            if expected_type == "Int":
                ...
                if isinstance(value, bool):
                    ...
                    if value_lower in ("yes", "true", "1"):
                        ...
                        raise ValueError(f"String '{value}' cannot be converted to Bool (expected yes/no, true/false, 1/0)")
