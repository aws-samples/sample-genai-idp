...
# Add lib to path
sys.path.insert(
    0, os.path.join(os.path.dirname(__file__), "..", "lib", "idp_common_pkg")
)
...
def test_user_isolation():
    ...
    pk1 = mock_client.transact_write_items.call_args_list[0][0][0][0]["Put"]["Item"][
        "PK"
    ]
    ...
    pk2 = mock_client.transact_write_items.call_args_list[1][0][0][0]["Put"]["Item"][
        "PK"
    ]
