...
echo "  6. Review parameters carefully:"
echo "     - AdminEmail: production admin email"
echo "     - IDPPattern: Pattern2 - Packet processing with Textract and Bedrock"
echo "     - Pattern2Configuration: rvl-cdip-package-sample (11 document types)"
echo "     - Other parameters as needed"
echo "  7. Click through to 'Update stack'"
echo "  8. Wait for deployment to complete (~15-20 minutes)"
echo ""
echo -e "${YELLOW}⚠️  CRITICAL: Set Pattern2Configuration=rvl-cdip-package-sample${NC}"
echo -e "${YELLOW}   This provides 11 document types including invoice${NC}"
echo ""
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${BLUE}Document Types in Production (rvl-cdip-package-sample):${NC}"
echo "  1. letter              - Formal correspondence"
echo "  2. form                - Structured documents with fields"
echo "  3. invoice             - Billing documents ✓"
echo "  4. resume              - Professional summaries"
echo "  5. scientific_publication - Academic papers"
echo "  6. memo                - Internal communications"
echo "  7. advertisement       - Marketing materials"
echo "  8. email               - Electronic correspondence"
echo "  9. questionnaire       - Survey forms"
echo "  10. specification      - Technical documents"
echo "  11. generic            - Catch-all category"
echo ""
