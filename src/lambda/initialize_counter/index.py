    ...
    try:
        ...
        if event["RequestType"] == "Create":
            concurrency_table.put_item(
                Item={"counter_id": COUNTER_ID, "active_count": 0},
            ...
            concurrency_table.delete_item(Key={"counter_id": COUNTER_ID})
        ...
        cfnresponse.send(
            event, context, cfnresponse.FAILED, {"Error": str(e)}, reason=str(e)
        )
        raise
