...
def adjust_section_positions(
    widgets: List[Dict[str, Any]], start_y: int = 0
) -> List[Dict[str, Any]]:
    """
...
def merge_dashboard_bodies(
    dashboard_1_body: str, dashboard_2_body: str
) -> Dict[str, Any]:
    ...
    try:
        ...
        d1_timeseries, d1_tables, d1_other = split_widgets_by_type(
            dashboard_1["widgets"]
        )
        d2_timeseries, d2_tables, d2_other = split_widgets_by_type(
            dashboard_2["widgets"]
        )
...
def create_or_update_dashboard(
    dashboard_name: str, dashboard_body: Dict[str, Any]
) -> None:
