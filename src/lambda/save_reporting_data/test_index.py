...
def test_handler_success(mock_document_from_dict, mock_save_reporting_data):
    ...
    mock_save_reporting_data.assert_called_once_with(
        "test-reporting-bucket", "test-stack-reporting-db", "test-config-table"
    )
...
def test_handler_no_config_table(
    ...
    assert (
        "No configuration table name provided, will use hardcoded pricing values"
        in caplog.text
    )
...
def test_handler_with_database_name_in_event(
    ...
    mock_save_reporting_data.assert_called_once_with(
        "test-reporting-bucket", "custom-database-name", "test-config-table"
    )
