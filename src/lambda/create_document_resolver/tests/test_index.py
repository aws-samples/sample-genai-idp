...
class TestUserIdExtraction:
    ...
    def test_extract_user_id_from_username(self, valid_uuid):
        ...
        event = {"identity": {"username": valid_uuid}}
    ...
    def test_extract_user_id_prefers_username(self):
        ...
        event = {
            "identity": {"username": "preferred-username-id", "sub": "fallback-sub-id"}
        }
        user_id = index.extract_user_id(event)
...
class TestHandler:
    ...
    def test_handler_creates_user_scoped_key(
        self, mock_dynamodb, valid_event, mock_context, valid_uuid
    ):
    ...
    @patch("index.dynamodb")
    def test_handler_uses_sub_when_username_missing(
        self, mock_dynamodb, event_with_sub, mock_context, valid_uuid
    ):
    ...
    def test_handler_missing_object_key_raises_error(self, mock_dynamodb, valid_uuid):
        ...
        event = {
            ...
            "arguments": {"input": {"QueuedTime": "2025-01-15T10:30:00Z"}},
        }
    ...
    def test_handler_missing_queued_time_raises_error(self, mock_dynamodb, valid_uuid):
        ...
        event = {
            "identity": {"username": valid_uuid},
            "arguments": {"input": {"ObjectKey": "test.pdf"}},
        }
    ...
    def test_handler_empty_input_data_raises_error(self, mock_dynamodb, valid_uuid):
        ...
        event = {"identity": {"username": valid_uuid}, "arguments": {"input": {}}}
    ...
    def test_handler_missing_user_id_raises_error(self):
        ...
        event = {
            "identity": {},
            "arguments": {
                "input": {"ObjectKey": "test.pdf", "QueuedTime": "2025-01-15T10:30:00Z"}
            },
        }
    ...
    @patch("index.dynamodb")
    def test_handler_includes_expires_after(
        self, mock_dynamodb, valid_event, mock_context
    ):
    ...
    @patch("index.dynamodb")
    def test_handler_uses_calculated_shard(
        self, mock_dynamodb, mock_calculate_shard, valid_event, mock_context
    ):
