...
/**
 * Returns the list of features present in the seller bucket catalog (both
 ...
 * prefixes in the seller bucket. The catalog is therefore data-driven: a
 ...
 *    AppSync schema, and
 *  - A missing / unreachable seller bucket is a valid state — the UI should
...
export default function useCatalogFeatures(): UseCatalogFeaturesReturn {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      // See docblock: feature platform may be disabled or seller bucket absent.
