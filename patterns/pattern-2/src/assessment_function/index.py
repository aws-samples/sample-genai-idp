...
def handler(event, context):
    ...
    if granular_enabled:
        ...
        logger.info(
            "Using granular assessment service with enhanced error handling and caching"
        )
    else:
    ...
    assessment_enabled = normalize_boolean_value(
        assessment_config.get("enabled", False)
    )
    validation_enabled = assessment_enabled and normalize_boolean_value(
        assessment_config.get("validation_enabled", True)
    )
