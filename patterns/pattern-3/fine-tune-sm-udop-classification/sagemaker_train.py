...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max-epochs", type=int, default=3, help="Max epoch for training"
    )
    parser.add_argument(
        "--base-model", type=str, default="microsoft/udop-large", help="Base model name"
    )
    parser.add_argument(
        "--data-bucket",
        type=str,
