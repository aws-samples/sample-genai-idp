...
def invoke(endpoint_name, input_image, input_textract, prompt="", debug=0):
    ...
    response = sagemaker_runtime.invoke_endpoint(
        EndpointName=endpoint_name, ContentType="application/json", Body=input_data
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-image", type=str, required=True, help="Original image")
    parser.add_argument(
        "--input-textract",
        type=str,
        required=True,
    ...
    parser.add_argument("--debug", type=int, default=0, help="Set to 1 to see prompt")
