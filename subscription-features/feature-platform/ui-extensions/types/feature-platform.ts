...
/**
 * A feature discovered in the seller bucket's `features/<id>/` prefix,
 * whether or not this IDP stack has it installed. Drives the nav section's
 * catalog entries and the FeaturePage Subscribe CTA.
 */
...
export interface InstalledFeature {
  ...
  /** Populated from the seller bucket's latest.json; null if unknown. */
...
export interface FeatureEntitlement {
  ...
  source: 'marketplace' | 'simulator' | 'none';
  /**
