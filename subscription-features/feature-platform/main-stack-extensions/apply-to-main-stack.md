  ...
  FeaturePlatformStack:
    ...
    Properties:
      ...
      Parameters:
        ...
        SellerBucketName: !Ref FeaturePlatformSellerBucket
        SellerBucketRegion: !Ref FeaturePlatformSellerBucketRegion
